...
export const MonthFakes = () => {
  ...
  const isYear = current ? "&year=" + `${defaultYear.year}` : "";
      ...
      <div className={styles.main}>
        <div>
          ...
          <div className={styles.yearsWrap}>
            <Link href={`/2022/${month}`}>
              <p
                className={year == "2022" ? styles.yearActive : styles.year}
                onClick={() => setCurrent("2022")}
              >
                2022
              </p>
            </Link>
            <Link href={`/2023/${month}`}>
              <p
                className={year == "2023" ? styles.yearActive : styles.year}
            ...
            {month && (
              <div>
                ...
                <p className={styles.tagHeading}>
                  {month && <SpetialText name={monthName} />},{" "}
                  {defaultYear.year}
                </p>
                <hr
                  style={{
